...
def registrarVenta(request):
    ...
    guardarVenta=Ventas.objects.create(codigo=codigo, fecha=fecha,total_venta=total_venta, id_cliente=id_cliente, metodo_pago=metodo_pago, id_empleado=id_empleado, estatus=estatus)
